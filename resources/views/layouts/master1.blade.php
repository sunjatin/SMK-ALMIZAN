...
<html lang="en">
  <head>
    ...
    <title>SMK MA'ARIF AL-MIZAN | Home</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="Varsity/assets/img/favicon.png" type="image/ x-icon">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="mu-header-top-left">
                  <div class="mu-top-email">
                    ...
                    <span>smk.maarif.almizan@gmail.com</span>
                  </div>
                  <div class="mu-top-phone">
                    <i class="fa fa-phone"></i>
                    <span>(+62) 83824430157</span>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                <div class="mu-header-top-right">
                  <nav>
                    <ul class="mu-top-social-nav">
                      ...
                      <li><a href="https://www.youtube.com/channel/UCx_4TneWaanonLr1XvvVm3w"><span class="fa fa-youtube"></span></a></li>
                    </ul>
                  </nav>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Program Keahlian <span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="/info_tkj">Teknik Komputer & Jaringan (TKJ)</a></li>
                <li><a href="/info_pbs">Perbankan Syariah (PBS)</a></li>                
                <li><a href="/info_tb">Tata Busana (TB)</a></li>
                <li><a href="/info_tbsm">Teknik Bisnis Sepeda Motor (TBSM)</a></li>                
              </ul>
            </li>           
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Daftar<span class="fa fa-angle-down"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="calonsiswa/create">Siswa Baru</a></li>                
                <li><a href="calonsiswa/create">Siswa Pindahan</a></li>  
    ...
    <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; All Right Reserved. Designed by <a href="http://www.markups.io/" rel="nofollow">Jabbarmuhammad20</a></p>
        </div>
      </div>
    </div>
    <!-- end footer bottom -->
