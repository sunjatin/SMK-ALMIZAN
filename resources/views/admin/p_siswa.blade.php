...
<div class="col-lg-12">
	<div class="card card-primary card-outline">
		<div class="card-header">
			<h5 class="card-title m-0"><i class="fas fa-info"></i> Pengaturan Data Siswa</h5>
		</div>
		<div class="card-body">
			<center>
			...
			<a href="/exportexcelsiswa" class="btn bg-gradient-success"><i class="fas fa-download"></i> Unduh Data</a>
			<p></p>
			
			<p></p>

			<form action="{{url('/importexcelsiswa')}}" role="form" enctype="multipart/form-data" method="post">
				{{csrf_field()}}
